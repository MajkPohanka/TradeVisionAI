...
import { Sliders, Clock, ShieldAlert, Cpu, FileText, ChevronDown, ChevronUp, Bot, Check } from 'lucide-react';
...
export const StrategyPreferences: React.FC<StrategyPreferencesProps> = ({
  ...
  return (
    <div className="bg-[#121216] border border-white/[0.08] rounded-3xl p-5 sm:p-6 shadow-[0_8px_32px_rgba(0,0,0,0.37)] transition-all">
      <div
