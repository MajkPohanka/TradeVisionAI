...
const ASSET_DEFINITIONS: Array<{
  ...
  // 2. GOLD & COMMODITIES (Max 4)
  {
    ...
    categoryLabelEs: 'Materias Primas',
    currency: 'USD',
    precision: 2,
    ...
    try {
      ...
      const finalAssets: MarketAssetData[] = ASSET_DEFINITIONS.map((def) => {
        ...
        return {
          ...
          categoryLabelEs: def.categoryLabelEs,
